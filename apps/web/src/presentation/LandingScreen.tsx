...
export const LandingScreen = ({ onGetStarted, onOpenTerms }: Props) => {
    ...
    return (
        <div className="min-h-screen bg-charcoal-50 text-brand-700 overflow-x-clip">
                ...
                {mobileOpen && (
                    <div className="lg:hidden border-t border-charcoal-200 bg-charcoal-50">
                        <div className="px-5 py-4 flex flex-col gap-1 text-[15px] font-medium text-brand-600">
                            {navLinks.map((l) => (
                                <button key={l.id} type="button" onClick={() => scrollTo(l.id)} className="text-left flex items-center min-h-11">
                                    {l.label}
                                </button>
                            ))}
                            <div className="h-px bg-charcoal-200 my-2" />
                            <button type="button" onClick={onGetStarted} className="text-left flex items-center min-h-11">{t('landing.navSignIn')}</button>
                            <button
                                type="button"
                                onClick={onGetStarted}
                    ...
                    <div className="max-w-3xl mx-auto text-center">
                        ...
                        <div className="mt-14 max-w-md mx-auto">
                            <div className="relative">
                                {/* fanned toolkit docs behind — tucked in on phone so they can't
                                    bleed past the mock; fanned out from sm up. */}
                                <div aria-hidden className="absolute -right-1.5 sm:-right-5 top-8 w-[78%] h-[88%] rounded-xl bg-charcoal-50 border border-charcoal-200 shadow-lg shadow-brand-900/5 rotate-[3deg] sm:rotate-[5deg]" />
                                <div aria-hidden className="absolute -right-1 sm:-right-2.5 top-4 w-[82%] h-[92%] rounded-xl bg-charcoal-50 border border-charcoal-200 shadow-lg shadow-brand-900/5 rotate-[1.5deg] sm:rotate-[2.5deg]" />
                                ...
                                <div className="relative bg-charcoal-50 rounded-xl border border-charcoal-200 shadow-2xl shadow-brand-900/15 overflow-hidden text-left">
                                    <div className="px-5 pt-6 pb-6 sm:px-8 sm:pt-7">
                                        <div className="flex flex-col gap-1.5 sm:flex-row sm:items-baseline sm:justify-between sm:gap-3 border-b border-charcoal-200 pb-4 mb-4">
                            ...
                            {/* Same proof signal, inline, on phone (the floating chip is sm+). */}
                            <div className="sm:hidden mt-8 flex items-center gap-3 bg-brand-700 text-charcoal-50 rounded-2xl px-4 py-3 text-left">
                                <span className="h-9 w-9 rounded-full bg-accent-400/15 border border-accent-400/30 text-accent-300 flex items-center justify-center shrink-0">
                                    <Sparkles size={16} />
                                </span>
            ...
            <section id="toolkit" className="py-14 sm:py-20 lg:py-28">
                <div className="max-w-6xl mx-auto px-5 sm:px-8">
                    ...
                    <div className="border-t border-charcoal-200">
                        {toolkit.map((item) => (
                            <div
                                key={item.n}
                                className="group flex flex-col gap-2 md:grid md:grid-cols-12 md:gap-8 md:items-baseline py-6 md:py-7 border-b border-charcoal-200 sm:hover:bg-charcoal-100/60 transition-colors sm:-mx-4 sm:px-4 rounded-lg"
                            >
                                {/* On phone, number sits inline beside the title (a clean row);
            ...
            <section id="pricing" className="bg-charcoal-100 py-14 sm:py-20 lg:py-28 border-y border-charcoal-200">
                <div className="max-w-6xl mx-auto px-5 sm:px-8">
                    <div className="max-w-3xl mb-14">
                    ...
                    <div className="grid lg:grid-cols-12 gap-8 lg:gap-12 items-start">
                        ...
                        <div className="lg:col-span-7">
                            <div className="rounded-2xl border border-charcoal-200 bg-charcoal-50 overflow-hidden divide-y divide-charcoal-200">
                                {compareRows.map((row) => (
                                    <div key={row.label} className={`flex items-center justify-between gap-4 px-4 py-5 sm:px-6 ${row.muted ? '' : 'bg-brand-700 text-charcoal-50'}`}>
                        ...
                        <div className="lg:col-span-5">
                            <div className="rounded-3xl border-2 border-accent-300 bg-charcoal-50 p-7 sm:p-8 shadow-xl shadow-accent-900/5">
                                ...
                                <div className="flex items-baseline gap-2 mb-1">
                                    <span className="font-display text-5xl sm:text-6xl font-semibold text-brand-700">{t('landing.packPrice')}</span>
            ...
            {/* Reviews */}
            <section id="reviews" className="bg-charcoal-100 py-14 sm:py-20 lg:py-28 border-y border-charcoal-200">
                <div className="max-w-6xl mx-auto px-5 sm:px-8">
                    <div className="max-w-3xl mb-14">
            ...
            <footer className="border-t border-charcoal-200 bg-charcoal-50 py-12">
                <div className="max-w-6xl mx-auto px-5 sm:px-8 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
                    ...
                    <div className="flex flex-wrap gap-x-6 gap-y-1 text-sm text-brand-500 -my-1.5">
                        ...
                        <a href="#how" className="hover:text-brand-700 transition-colors py-1.5 inline-flex items-center">{t('landing.navHow')}</a>
