...
- [ ] Apply migrations 001 through 020 in the Supabase SQL editor (010 backfills `profiles.created_at`/`updated_at` for the Users tab; 011 adds webhook replay protection; 013 adds the analytics/BI surface; 020 adds the AI failure-telemetry columns + views).
